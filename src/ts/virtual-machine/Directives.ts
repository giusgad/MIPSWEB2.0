...
export abstract class Directive {
    abstract assemble(tokens: string[],  globals: Map<string, Binary | undefined>, labels: Map<string, Binary | undefined>,  address: Binary,  assembler: Assembler,  editorPosition: {fileId: number, lineNumber: number}): void;
...
export class asmDirective extends Directive {
    ...
    assemble(tokens: string[],  globals: Map<string, Binary | undefined>,  labels: Map<string, Binary | undefined>,  address: Binary,  assembler: Assembler,  editorPosition: {fileId: number, lineNumber: number}) {
    ...
    assembleInstruction(tokens: string[], globals: Map<string, Binary | undefined>, labels: Map<string, Binary | undefined>, address: Binary, assembler: Assembler, editorPosition: {fileId: number, lineNumber: number}) {

        assembler.addressEditorsPositions.set(address.getValue(), editorPosition);
        const code: Binary = assembler.assembleInstruction(tokens, globals, labels, address);
