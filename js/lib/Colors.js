...
export class Colors {
    static isDarkMode() {
        ...
        const settingsTheme = (_a = getFromStorage('local', 'settings')) === null || _a === void 0 ? void 0 : _a.theme;
    ...
    static generateCSSVariables() {
        ...
        style.type = 'text/css';
        const cssVariables = Object.entries(this.items).flatMap(([name, color]) => {
...
Colors.items = {
    ...
    'ace-modifier': { light: 'rgb(149, 60, 140)', dark: 'rgb(199, 125, 187)' },
    'ace-string': { light: 'rgb(57, 108, 46)', dark: 'rgb(106, 171, 115)' },
    'ace-function': { light: 'rgb(16,89,147)', dark: 'rgb(97, 175, 239)' },
    'ace-variable': { light: 'rgb(253, 151, 30)', dark: 'rgb(209, 154, 102)' },
    ...
    'blue': { light: 'rgb(0,122,255)', dark: 'rgb(10,132,255)' },
